...
export default function AdminDashboard() {
      ...
      items: [
        {
          ...
          path: "/control-panel/universities",
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 text-slate-900 dark:text-zinc-50 pb-20">
