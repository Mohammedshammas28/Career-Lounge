  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="py-20 lg:py-32 relative overflow-hidden">
        ...
        <div className="relative z-20 mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center" style={{ animation: "fadeInUp 0.6s ease-out 0.1s both" }}>
            <div className="h-16 w-16 rounded-xl bg-emerald-500/20 backdrop-blur-sm flex items-center justify-center mx-auto mb-6">
              <Home className="h-8 w-8 text-emerald-400" />
            </div>
            <p className="text-sm font-bold uppercase tracking-widest text-emerald-300 mb-3">Recruitment Services</p>
            ...
            <Link href={`/contact?service=${encodeURIComponent("Domestic Recruitment")}`}>
              <Button className="bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-6 text-base font-bold">
                Get Placed Today <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div style={{ animation: "fadeInUp 0.6s ease-out 0.2s both" }}>
              <h2 className="text-3xl font-bold text-foreground mb-6">Local Talent, Local Opportunities</h2>
      ...
      <section className="py-16 lg:py-24 bg-card/50">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-foreground text-center mb-12">Industries We Serve</h2>
      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-foreground mb-4">Domestic Job Opportunities</h2>
      ...
      {/* CTA */}
      <section className="py-16 lg:py-24 bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/20 border-t border-border">
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-foreground mb-6">Ready to Start Your Career Journey?</h2>
